...
returning ""id""";
        ...
        public void IncrementCounter_WithExistingKey_AddsAnotherRecord()
        {
            UseConnection(sql =>
            {
                ...
                var recordCount = sql.Query<long>(@"select count(*) from """ + GetSchemaName() + @""".""counter""")
                    .Single();
        ...
        public void AddToSet_AddsARecord_WhenKeyIsExists_ButValuesAreDifferent()
        {
            UseConnection(sql =>
            {
                ...
                var recordCount = sql.Query<long>(@"select count(*) from """ + GetSchemaName() + @""".""set""")
                    .Single();
        ...
        public void InsertToList_AddsAnotherRecord_WhenBothKeyAndValueAreExist()
        {
            UseConnection(sql =>
            {
                ...
                var recordCount = sql.Query<long>(@"select count(*) from """ + GetSchemaName() + @""".""list""")
                    .Single();
        ...
        public void AddRangeToSet_AddsAllItems_ToAGivenSet()
        {
            UseConnection(sql =>
            {
                ...
                var records = sql.Query<string>(@"select ""value"" from """ + GetSchemaName() +
        ...
        public void ExpireHash_SetsExpirationTimeOnAHash_WithGivenKey()
        {
            ...
            UseConnection(sql =>
            {
                ...
                // Assert
                var records = sql.Query(@"select * from """ + GetSchemaName() + @""".hash")
        ...
        public void ExpireSet_SetsExpirationTime_OnASet_WithGivenKey()
        {
            ...
            UseConnection(sql =>
            {
                ...
                // Assert
                var records = sql.Query(@"select * from """ + GetSchemaName() + @""".""set""")
                    .ToDictionary(x => (string) x.key, x => (DateTime?) x.expireat);
        ...
        public void ExpireList_SetsExpirationTime_OnAList_WithGivenKey()
        {
            ...
            UseConnection(sql =>
            {
                ...
                // Assert
                var records = sql.Query(@"select * from """ + GetSchemaName() + @""".""list""")
                    .ToDictionary(x => (string) x.key, x => (DateTime?) x.expireat);
